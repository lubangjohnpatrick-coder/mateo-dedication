...
- The invitation inside shows the two facing pages side by side as one landscape spread: the aqua verse/compass page opens on the left and the white SAVE THE DATE / event details page with the portrait baby photo and immigration stamp on the right, with the center crease. The supplied portrait crop is used directly.
